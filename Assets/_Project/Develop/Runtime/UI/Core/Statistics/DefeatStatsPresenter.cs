...
{
    public class DefeatStatsPresenter : IPresenter
    {
        ...
        public DefeatStatsPresenter(IconTextView view, GameplayStatisticsService statsService, ResetStatistics resetStatistics)
        {
            _view = view;
        ...
        {
            UpdateValue(_statsService.Defeats);
        ...
        private void OnValueReseted() => _view.SetText(_statsService.Defeats.ToString());
    }
}